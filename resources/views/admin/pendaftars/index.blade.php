...
<div class="bg-white rounded-xl border border-gray-200 p-6 mb-6">
    <form method="GET" action="{{ route('admin.pendaftars.index') }}" class="flex flex-wrap gap-4">
        ...
        <button type="submit" formaction="{{ route('admin.pendaftars.export') }}" class="px-6 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition flex items-center">
