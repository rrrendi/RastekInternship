        ...
        <aside id="sidebar" class="sidebar fixed md:static inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 flex flex-col">
            ...
            <nav class="flex-1 p-4 overflow-y-auto">
                ...
                <a href="{{ route('admin.pendaftars.index') }}"
                    class="flex items-center px-4 py-3 mb-2 text-gray-700 rounded-lg hover:bg-gray-100 transition {{ request()->routeIs('admin.pendaftars.*') ? 'bg-green-50 text-green-700 font-medium' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
