...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
        ...
        <div class="bg-gray-50 rounded-xl p-6 mb-6">
            ...
            <div class="grid md:grid-cols-2 gap-4 text-sm">
                ...
                <div>
                    ...
                    <p class="font-medium text-gray-900">{{ $applicant->created_at->format('d F Y') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gray-50 rounded-xl p-6 mb-6">
            ...
            <p class="text-gray-700 whitespace-pre-line">{{ $applicant->notes }}</p>
        </div>
        @endif

        <!-- Actions -->
        <div class="flex justify-center gap-4">
            <a href="{{ route('applicant.check-status') }}" class="px-6 py-3 border border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50 transition">
                Cek Email Lain
            </a>
